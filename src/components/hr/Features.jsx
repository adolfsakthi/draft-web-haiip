...
export default function Features() {
  return (
    <section className="w-full bg-[#F0F1F5] py-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {features.map((item, index) => (
            ...
            >
              ...
              {/* TITLE — POPPINS 500 */}
              <h3 className="text-lg font-poppins font-medium text-[#1f2937] mb-4">
                {item.title}
              </h3>

              {/* DESCRIPTION — POPPINS 400 */}
              <p className="text-sm font-poppins font-normal text-[#9CA3AF] leading-relaxed max-w-[260px] mx-auto">
                {item.desc}
              </p>
            </div>
          ))}
