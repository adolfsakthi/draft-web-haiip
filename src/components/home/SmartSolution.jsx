      ...
      <div className="relative w-[1442px] h-[610px] px-20 pt-12">
        ...
        <div className="flex justify-between items-start mb-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <h2 style={{ fontFamily: "Zen Dots, sans-serif" }} className="text-5xl font-normal text-black font-zendots">
              Smart Solutions
            </h2>
          </div>
        ...
        <div className="grid grid-cols-3 gap-20 px-10">
          ...
          {topCards.map((item, idx) => (
            ...
            >
              <h3 className="flex items-center gap-3 text-l font-bold font-poppins text-[#111]">
                <span>{item.icon}</span>
                {item.title}
              </h3>
              <p className="mt-3 text-[#6b7280] text-base leading-relaxed font-poppins font-normal">
                {item.desc}
              </p>
            </div>
          ))}
